...
import android.api.input.PUser;
import android.api.input.VUser;
import android.api.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public android.api.entity.User getOneUnsavedUser() {
