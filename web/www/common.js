...
let OrdersService = class OrdersService {
    ...
    query(params) {
        ...
        console.log(PARAM);
        return this.httpClient.get(`${this.url}/queryPlace`, { params: PARAM });
    }
    driverQuery(params) {
        console.log(params);
        /* 设置默认值 */
        ...
        console.log(PARAM);
        return this.httpClient.get(`${this.url}/driverPlace`, { params: PARAM });
    }
    ownerQuery(params) {
        /* 设置默认值 */
        if (params.page === undefined) {
        ...
        console.log(PARAM);
        return this.httpClient.get(`${this.url}/ownerPlace`, { params: PARAM });
    }
    /**
     * 更新
     */
    update(orderId, order) {
        return this.httpClient.put(`${this.url}/${orderId.toString()}`, order);
    }
    /**
     * 更新
     */
    default(orderId, order) {
        return this.httpClient.put(`${this.url}/default/${orderId.toString()}`, order);
    }
    /**
     * 更新
     */
    updateStatus(orderId, status) {
        return this.httpClient.put(`${this.url}/update/${orderId.toString()}`, status);
    }
    completeOrder(orderId, order) {
        return this.httpClient.put(`${this.url}/complete/${orderId.toString()}`, order);
    }
    confirmOrder(orderId, order) {
        return this.httpClient.put(`${this.url}/confirm/${orderId.toString()}`, order);
    }
    /**
     * 根据id获取订单
     * @param id  订单id
     ...
     */
    delete(orderId) {
        return this.httpClient.delete(`${this.url}/${orderId.toString()}`);
    }
    /**
     * 分页方法
     * @param page 第几页
    ...
    page(page, size) {
        ...
        return this.httpClient.get(`${this.url}/page`, { params });
    }
    /**
     * 分页方法
     * @param page 第几页
    ...
    pageById(page, size) {
        ...
        return this.httpClient.get(`${this.url}/pageById`, { params });
    }
    /**
     * 分页方法
     * @param page 第几页
     ...
     * @param userId 用户
     */
    pageByStatus(status, page, size) {
        const params = {
            status: Number(status),
            page: String(page),
            size: String(size),
        };
        return this.httpClient.get(`${this.url}/pageByStatus`, { params });
    }
    /**
     * 分页方法
     * @param page 第几页
     ...
     * @param userId 用户
     */
    pageByDriver(page, size) {
        const params = {
            page: String(page),
            size: String(size),
        };
        return this.httpClient.get(`${this.url}/pageByDriver`, { params });
    }
};
