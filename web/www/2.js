...
const Header = class {
  ...
  destroyCollapsibleHeader() {
    ...
    if (this.collapsibleMainHeader) {
      this.collapsibleMainHeader.classList.remove('header-collapse-person');
  ...
  async setupCollapsibleHeader(contentEl, pageEl) {
     ...
     * as well as progressively showing/hiding the person header
    ...
    Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__["c"])(() => {
      if (this.collapsibleMainHeader !== undefined) {
        this.collapsibleMainHeader.classList.add('header-collapse-person');
      }
    });
