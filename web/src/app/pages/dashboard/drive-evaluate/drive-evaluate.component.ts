...
import {isDefined, UnknownProperty} from '../../../core/secondUtils';
...
@Component({
  selector: 'app-main',
  templateUrl: './drive-evaluate.component.html',
  styleUrls: ['./drive-evaluate.component.css']
})
export class DriveEvaluateComponent implements OnInit {
