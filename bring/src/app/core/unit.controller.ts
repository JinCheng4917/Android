...
import {isNotNullOrUndefined} from './secondUtils';
...
export class UnitController {
   ...
   */
  private unitRecords = {} as Record<string, Record<string, Array<Record<any, any>>>>;
   ...
   * @param unit 组件、指令、管道
   */
  remove(unit: Record<any, any>): void {
    const className = unit.constructor.name;
    if (isNotNullOrUndefined(this.unitRecords[className])) {
